...
<head>
	...
	#select-area label{display:inline-block;width:100%;height:40px;overflow:hidden;line-height:20px;padding:10px 0;text-align:center;background-color:#ddd;color:#000;}
