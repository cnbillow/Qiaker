...
<div id="msg_o">
	<table cellpadding="0" cellspacing="4">
		...
		<tr>
			<th colspan="2"><input id="msg_sure" type="button" value="确定" onclick="url_go()" /></th>
		</tr>
	</table>
</div>
<script type="text/javascript" language="javascript">setTimeout(function(){url_go();},<?=$ms?>);</script>
</body>
</html>